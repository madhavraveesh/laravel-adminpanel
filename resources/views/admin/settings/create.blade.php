...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('global.page.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.pages.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('page_slug') ? 'has-error' : '' }}">
                <label for="title">{{ trans('global.page.fields.page_slug') }}*</label>
            ...
            <div class="form-group {{ $errors->has('cannonical_link') ? 'has-error' : '' }}">
                <label for="cannonical_link">{{ trans('global.page.fields.cannonical_link') }}</label>
            ...
            <div class="form-group {{ $errors->has('seo_title') ? 'has-error' : '' }}">
                <label for="seo_title">{{ trans('global.page.fields.seo_title') }}</label>
            ...
            <div class="form-group {{ $errors->has('seo_keyword') ? 'has-error' : '' }}">
                <label for="seo_keyword">{{ trans('global.page.fields.seo_keyword') }}</label>
            ...
            <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                <label for="status">{{ trans('global.page.fields.status') }}</label>
            ...
            <div class="form-group {{ $errors->has('created_by') ? 'has-error' : '' }}">
                <label for="created_by">{{ trans('global.page.fields.created_by') }}</label>
            ...
            <div class="form-group {{ $errors->has('updated_by') ? 'has-error' : '' }}">
                <label for="updated_by">{{ trans('global.page.fields.updated_by') }}</label>
